...
window.Vue = __webpack_require__(2); //disabled and make it go last as <src> in app.php, as cause [Vue warn]: $attrs is readonly
 //import Vuex Store
...
Vue.component('menu-one-item', __webpack_require__(296)); //components containing menu with (login/logged) switch
...
Component.options.__file = "resources/assets/js/Menu_One_Item/components/one-menu.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-03c3698c", Component.options)
  } else {
    hotAPI.reload("data-v-03c3698c", Component.options)
  }
...
var render = function() {
  ...
  return _c("span", [
    _vm._v(
      "  " +
        _vm._s(_vm.ifPassportTokenSet == null ? "LoginX" : "Logged-Dashboard") +
        " "
    )
  ])
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-03c3698c", module.exports)
  }
}
