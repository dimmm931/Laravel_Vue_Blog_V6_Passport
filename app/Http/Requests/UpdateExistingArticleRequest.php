...
class UpdateExistingArticleRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
		    ...
		    'imagesSet'    => 'array',                                      //validation for array of images
    ...
    public function messages()
    {
        ...
        return [
		   ...
		   'imagesSet.*.image'    => 'Make sure you have uploaded an image',
		   'imagesSet.*.mimes'    => 'Must be .jpeg, .png, .jpg, .gif, .svg file. Max size is 2048',
		   'imagesSet.*.max'      => 'Sorry! Maximum allowed size for an image is 2MB',
		   //'imagesSet.min'      => 'Your image is too small',
		];
	}
